      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <button
            ...
            className="w-full md:w-auto flex items-center justify-center px-4 py-2 bg-gold text-black rounded-lg hover:bg-yellow-600 transition"
          >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row w-full md:w-auto gap-2">
            ...
            <button className="flex items-center justify-center px-4 py-2 bg-gray-700 rounded-lg hover:bg-gray-600">
