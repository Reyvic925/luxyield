...
async function getPortfolioData(userId) {
  ...
  // Use the stored availableBalance from the User model instead of calculating it
  // This ensures the dashboard shows the correct balance from the database
...
router.post('/invest', auth, async (req, res) => {
  try {
    ...
    // Check available balance using the stored value from User model
